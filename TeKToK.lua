...
local url , res = https.request('https://frrek.cf/index.php/?id='..User..'') --- Developer :- @iiwiw 
data = JSON.decode(url)
if data.Ch_Member.QQQxx  ~= true then
Var = false
else
Var = true
end
...
url = 'https://raw.githubusercontent.com/ghostteam1/TeKToK/master/TeKToK.lua'
...
local UserName = (data.username_ or "QQQxx")
...
download_to_file('https://raw.githubusercontent.com/ghostteam1/TeKToK/master/TeKToK.lua','TeKToK.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/ghostteam1/Files_TeKToK/master/getfile.json")
if res == 200 then
...
local Get_Json, Res = https.request("https://raw.githubusercontent.com/ghostteam1/Files_TeKToK/master/Files_TeKToK/"..File_Name)
if Res == 200 then
...
𓂅 .GhosT TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [Source Channel](t.me/QQQxx)

𓂅 . [Dev Source ](t.me/iiwiw)     

𓂅 . [GhosT iNDT](t.me/TekTok0)     
 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
𓂅 . [TWS GhosT](t.me/rcrekbot)     
]]) 
...
local UserName = (b.username_ or "QQQxx")
